...
import { FaPlus, FaCheck, FaTrash, FaClock, FaExclamationCircle } from 'react-icons/fa';
            ...
            <div className="max-w-5xl mx-auto">
                <div className="flex justify-between items-center mb-8 glass-panel p-6 rounded-2xl shadow-xl">
                    <div>
                        ...
                        <p className="text-gray-500">Manage your daily to-dos and reminders</p>
                    </div>
                    <button
                ...
                <div className="grid gap-4">
                    {tasks.length === 0 ? (
                        <div className="text-center p-12 glass-panel rounded-2xl">
                            ...
                            <h3 className="text-xl font-bold text-gray-700">No tasks yet</h3>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-4 mt-3">
                                                ...
                                                <span className="text-xs text-gray-500 flex items-center gap-1 bg-gray-100 px-2 py-1 rounded-full">
                                                    <FaClock /> Due: {new Date(task.dueDate).toLocaleDateString()}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
